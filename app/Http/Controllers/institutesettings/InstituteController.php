...
class InstituteController extends Controller
{
    ...
    ->leftJoin('institutetype','institute.institutetypeid','=','institutetype.id')
    ->leftJoin('institutecategory','institute.institutecategoryid','=','institutecategory.id')
    ->leftJoin('institutesubcategory','institute.institutesubcategoryid','=','institutesubcategory.id')
    ->leftJoin('thanas','institute.thanaid','=','thanas.id')
    ->leftJoin('postoffices','institute.postofficeid','=','postoffices.id')
    ->leftJoin('localgovs','institute.localgovid','=','localgovs.id')
...
public function edit($id){
        ...
        if($permission[4]==1){
            ...
            ->leftJoin('institutesubcategory','institute.institutesubcategoryid','=','institutesubcategory.id')
            ->leftJoin('thanas','institute.thanaid','=','thanas.id')
            ->leftJoin('districts','thanas.districtid','=','districts.id')
